...
- YAML (Kubernetes manifests), HCL (OpenTofu) 1.6+ (004-cloudflare-zerotrust)
- Kubernetes Secret (tunnel token), ConfigMap (tunnel config file - ingress rules) (004-cloudflare-zerotrust)
...
## Recent Changes
- 004-cloudflare-zerotrust: Added YAML (Kubernetes manifests), HCL (OpenTofu) 1.6+
