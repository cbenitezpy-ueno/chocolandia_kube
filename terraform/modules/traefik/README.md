...
- **MetalLB Integration**: LoadBalancer service with static IP (192.168.4.240)
...
| loadbalancer_ip | Static LoadBalancer IP | string | "192.168.4.240" | no |
...
curl http://192.168.4.240  # Should return 404 (no routes configured yet)
```
